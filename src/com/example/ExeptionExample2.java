 ...
 * 예외를 처리하는 코드가 있어야 겠지?? => try,catch 
 * 
 * 예외처리를 강요하는 Exception이 있다. checked Exeption => Throws로 처리 
...
public class ExeptionExample2 {
	...
	public static void main(String[] args) {
		...
		}catch (InputMismatchException e) {  // 23행에서 발생한 예외를 매개변수 e 안에 넣는다. 처리해야 겠지? catch의 수행문에 처리코드를 넣는다.
